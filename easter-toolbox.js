export default (Blockly, value) => {
  ...
  <block type="weird-to-normal"/>
          ...
          <category name="Dashboard" colour="#3333ff">
          <label text="Dashboard starter" web-class="boldtext"></label>
          <block type="start_ahq_dash"/>
          <label text="Dashboard Starter Resources" web-class="boldtext"></label>
          <block type="dash_perms"/>
          <block type="make_cookie"/>
          <block type="load_cookie"/>
          <label text="Dashboard Options" web-class="boldtext"></label>
