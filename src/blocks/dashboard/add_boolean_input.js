...
const blockData = {
    ...
    "message0": "Add a boolean input %1 Set input title to %2 Set input description to %3 Set input ID to (DO NOT INCLUDE SPACES) %4 %5 Set value setter %6 Set value getter %7 Default value getter value %8",
    "args0": [
        {
            "type": "input_dummy"
        },
