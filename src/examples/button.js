export default `<xml xmlns="https://developers.google.com/blockly/xml">
                  ...
                  <block type="s4d_send_button" id="C6N[E}e;5;$}?Vt\`CVGi">
                    ...
                    <value name="BUTTON">
                      <block type="s4d_message_block" id="6O20D%C#^Cyw$.FdopP}">
                        ...
                        <comment pinned="true" h="80" w="188.4444580078125">buttons cannot have space in id!</comment>
                        <value name="LABEL">
  ...
  <block type="s4d_on_click" id="W_oym!aTfS$?|QDfaI.P" x="-516" y="332">
    <comment pinned="true" h="72.00003051757812" w="270.22222900390625">this is the event that get when the button was clicked</comment>
    <statement name="STATEMENTS">
      <block type="controls_if" id="{gT[%Nqi|m9pb1W^(;23">
        <value name="IF0">
          <block type="logic_compare" id="gBO:HYHk[-/{qi+/_6/e">
            <field name="OP">EQ</field>
            <comment pinned="true" h="77.33334350585938" w="423.11114501953125">seeing if the button id is the same as the button that i want to see if it was clicked</comment>
            <value name="A">
          ...
          <block type="s4d_send_channel" id="sg2]e(!0_JB,Gp~2xRaP">
            <value name="CONTENT">
              <block type="text_join" id="]Wdv!6|aWPaYp%?7qYhc">
                ...
                <comment pinned="true" h="87.11111450195312" w="385.77777099609375">pinging the member that has clicked the button</comment>
                <value name="ADD0">
            ...
            <next>
              <block type="s4d_button_think" id="yA51X}^SDmnM,PoHB1\`-">
                <comment pinned="true" h="75.55557250976562" w="284.4444580078125">making the button think</comment>
                ...
                <next>
                  <block type="s4d_wait_seconds" id="!XX?_!L7el[j;%::wbjM">
                    ...
                    <next>
                      <block type="s4d_button_reply" id="UXPQtW)vYg}.8Wh8WEz}">
                        <comment pinned="true" h="89.7777099609375" w="296.88885498046875">u need to use the think block first to use this block!</comment>
                        <value name="REPLY">
